...
// ClassSubjectFilter defines filter criteria for listing class-subject assignments.
...
type ClassSubjectAssignment struct {
	...
	ClassGrade   string  `db:"class_grade" json:"class_grade,omitempty"`
	ClassTrack   string  `db:"class_track" json:"class_track,omitempty"`
